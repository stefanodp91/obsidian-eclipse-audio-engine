...
This repository must contain no credentials or consumer configuration. Service accounts, signing
material, environment files, project identifiers, event taxonomies, and user data belong to the
consuming application and its protected CI environment.
